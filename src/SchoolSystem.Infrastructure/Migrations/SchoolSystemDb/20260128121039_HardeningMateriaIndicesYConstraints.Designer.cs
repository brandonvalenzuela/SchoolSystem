...
namespace SchoolSystem.Infrastructure.Migrations.SchoolSystemDb
{
    ...
    [Migration("20260128121039_HardeningMateriaIndicesYConstraints")]
    partial class HardeningMateriaIndicesYConstraints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchoolSystem.Domain.Entities.Academico.Materia", b =>
                {
                    ...
                    b.HasIndex("EscuelaId", "Nombre")
                        .IsUnique()
                        .HasDatabaseName("UX_Materias_Escuela_Nombre");
