        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SitioWeb = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EscuelaId = table.Column<int>(type: "int", nullable: false),
                    UsuarioId = table.Column<int>(type: "int", nullable: false),
                    Ocupacion = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LugarTrabajo = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TelefonoTrabajo = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    DireccionTrabajo = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Puesto = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CicloEscolar = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "AlumnoPuntos",
                columns: new[] { "AlumnoId", "CicloEscolar" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "AlumnoPuntos",
                columns: new[] { "EscuelaId", "CicloEscolar", "PuntosTotales" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "EstadosCuenta",
                columns: new[] { "EscuelaId", "CicloEscolar", "TieneAdeudos" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GrupoMateriaMaestros_CicloEscolar",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "GrupoMateriaMaestros",
                columns: new[] { "EscuelaId", "GrupoId", "MateriaId", "CicloEscolar" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "GrupoMateriaMaestros",
                columns: new[] { "GrupoId", "CicloEscolar" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Grupos",
                columns: new[] { "EscuelaId", "CicloEscolar", "Activo" });

            migrationBuilder.CreateIndex(
                name: "IX_Grupos_Escuela_Grado_Nombre_Ciclo_Unique",
                table: "Grupos",
                columns: new[] { "EscuelaId", "GradoId", "Nombre", "CicloEscolar" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Grupos",
                columns: new[] { "GradoId", "CicloEscolar", "Activo" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Inscripciones",
                columns: new[] { "AlumnoId", "GrupoId", "CicloEscolar" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inscripciones_CicloEscolar",
                table: "Inscripciones",
                column: "CicloEscolar");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Inscripciones",
                columns: new[] { "EscuelaId", "CicloEscolar", "Estatus" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Inscripciones",
                columns: new[] { "GrupoId", "CicloEscolar", "Estatus" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "PeriodosEvaluacion",
                columns: new[] { "CicloEscolar", "Numero" });

            migrationBuilder.CreateIndex(
                name: "IX_PeriodosEvaluacion_CicloEscolar",
                table: "PeriodosEvaluacion",
                column: "CicloEscolar");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "PeriodosEvaluacion",
                columns: new[] { "EscuelaId", "CicloEscolar", "Numero" },
                unique: true);
